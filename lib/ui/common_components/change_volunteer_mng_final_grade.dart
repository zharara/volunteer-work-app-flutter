...
void changeVolunteerMngFinalGrade(
  ...
  gradeTEC.text = volunteerStudentDto.finalGrade?.toString() ?? '';
  notesTEC.text = volunteerStudentDto.finalGradeNotes ?? '';
        ...
        return BlocListener<ChangeVolunteerGradeCubit,
            ...
            if (state is ChangeVolunteerGradeSuccess) {
              ...
              context
                  ...
                  .updateItemInternally(volunteerStudentDto.copyWith(
                    finalGrade: state.data.finalGrade,
                    finalGradeNotes: state.data.finalGradeNotes,
                  ));
          ...
          child: Scaffold(
            appBar: const BottomSheetAppBar(
              title: 'تقييم الإدارة النهائي للمتطوع',
            ),
                    ...
                    onPressed: () {
                      if (formKey.currentState?.validate() ?? false) {
                        BlocProvider.of<ChangeVolunteerGradeCubit>(context)
                          ...
                          finalGrade: double.parse(gradeTEC.text),
                          finalGradeNotes: notesTEC.text,
                        );
                      }
                    },
