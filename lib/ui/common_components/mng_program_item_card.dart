...
import '../pages/management/programs/mng_view_internal_program_datails_page.dart';
import 'dialogs.dart';

class MngProgramItemCard extends StatelessWidget {
  const MngProgramItemCard({Key? key, required this.item}) : super(key: key);
                          ...
                          loadingOrDeleteButton: BlocConsumer<
                              ...
                              listener: (context, state) {
                                ...
                                is DeleteProgramSuccess) {
                                  ...
                                  context
                                      .read<
                                      GetAllOrganizationsProgramsCubit>()
                                      .deleteItemInternally(item.id!);
                ...
                IconButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (ctx) => item.isInternalProgram ?? false
                              ? MngViewInternalProgramPage(programDto: item)
                              : MngViewOrgProgramDetailsPage(programDto: item),
                        ),
                      );
                    },
