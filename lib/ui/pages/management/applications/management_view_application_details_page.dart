...
class ManagementViewApplicationDetailsPage extends StatefulWidget {
  const ManagementViewApplicationDetailsPage({Key? key, required this.applicationDto}) : super(key: key);

  final StudentApplicationDto applicationDto;

  @override
  State<ManagementViewApplicationDetailsPage> createState() => _ManagementViewApplicationDetailsPageState();
}

class _ManagementViewApplicationDetailsPageState extends State<ManagementViewApplicationDetailsPage> {
...
@override
  void initState() {
    ...
    _applicationDto = widget.applicationDto;
                      ...
                      child: ListTile(
                        onTap: () {
                          downloadAndOpenFileDialog(
                              context: context,
                              fileKey: _applicationDto.submittedFile!.fileKey!);
                        },
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(10),
                        ),
                        ...
                        title: Text(_applicationDto.submittedFile
                            ?.originalFileName ??
                            '-'),
                        subtitle: Text(_applicationDto.submittedFile?.fileExtension ??
                            '-'),
                  ...
                  trailing: IconButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (ctx) => ManagementViewOpportunityDetailsPage(
                                opportunity: _applicationDto.volunteerOpportunity!),
                          ),
                        );
                      },
                      icon: const Icon(Icons.arrow_forward)),
