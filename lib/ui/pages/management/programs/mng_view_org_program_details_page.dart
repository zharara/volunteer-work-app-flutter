...
import 'package:volunteer_work_app/ui/pages/management/tasks/mng_view_org_program_task_details_page.dart';
...
import '../../../common_components/change_volunteer_mng_final_grade.dart';
...
import '../work_days/mng_view_org_program_work_day_details_page.dart';

class MngViewOrgProgramDetailsPage extends StatefulWidget {
  const MngViewOrgProgramDetailsPage({Key? key, required this.programDto})
      : super(key: key);

  final VolunteerProgramDto programDto;

  @override
  State<MngViewOrgProgramDetailsPage> createState() =>
      _MngViewOrgProgramDetailsPageState();
}

class _MngViewOrgProgramDetailsPageState
    extends State<MngViewOrgProgramDetailsPage> {
  int _tabIndex = 0;
                        ...
                        trailing: IconButton(
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) =>
                                      MngViewOrgProgramTaskDetailsPage(
                                    taskDto: item,
                ...
                Padding(
                  ...
                  child: Card(
                    child: ListTile(
                        ...
                        subtitle:
                            Text('التاريخ: ${item.date?.getDateString()}'),
                        trailing: IconButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) =>
                                      MngViewOrgProgramWorkDayDetailsPage(
                                    workDayDto: item,
                                    programId: _programDto.id ?? 0,
                                  ),
                                ),
