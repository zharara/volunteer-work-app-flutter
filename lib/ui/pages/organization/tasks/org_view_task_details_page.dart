...
class OrgViewTaskDetailsPage extends StatefulWidget {
  const OrgViewTaskDetailsPage(
  ...
  @override
  State<OrgViewTaskDetailsPage> createState() => _OrgViewTaskDetailsPageState();
}

class _OrgViewTaskDetailsPageState extends State<OrgViewTaskDetailsPage> {
  @override
  void initState() {
    super.initState();
                                        ...
                                        children: [
                                          Checkbox(
                                              value: taskAccomplishItem
                                                      ?.isAccomplished ??
                                                  false,
                                              onChanged: (accomplished) {
                                                if (accomplished ?? false) {
                                                  changeVolunteerTaskAccomplish(
                                                      context,
                                                      item,
                                                      widget.taskDto,
                                                      taskAccomplishItem);
                                                  ...
                                                  showDialog(
                                                    ...
                                                    builder: (dContext) => BlocListener<
                                                        DeleteTaskAccomplishCubit,
                                                        DeleteTaskAccomplishState>(
                                                      listener:
                                                          (context, state) {
                                                        if (state
                                                            is DeleteTaskAccomplishError) {
                                                        ...
                                                        if (state
                                                            is DeleteTaskAccomplishSuccess) {
                                                          context
                                                              .read<
                                                                  GetAccomplishesOfTaskCubit>()
                                                          ...
                                                          showSuccessSnackBar(
                                                            context: context,
                                                            message:
                                                                'تم إلغاء تعيين إنجاز المتطوع للمهمة بنجاح',
                                                          );
                                                        }
                                                      },
                                                      child: AlertDialog(
                                                        ...
                                                        content: Text(
                                                          'هل أنت متأكد من إلغاء تحديد إنجاز المتطوع ${item.student?.fullName ?? ''} للمهمة؟',
                                                        ),
                                                        actionsAlignment:
                                                            MainAxisAlignment
                                                                .spaceEvenly,
                                                        actions: [
                                                          ...
                                                          BlocBuilder<
                                                            ...
                                                            builder: (context,
                                                                state) {
                                                              if (state
                                                                  is DeleteTaskAccomplishLoading) {
                                                                return Transform
                                                                    .scale(
                                                                        scale:
                                                                            0.7,
