...
import 'package:volunteer_work_app/ui/common_components/add_new_work_day_floating_button.dart';
import 'package:volunteer_work_app/ui/common_components/change_volunteer_org_assessment.dart';
import 'package:volunteer_work_app/ui/common_components/update_task_button.dart';
import 'package:volunteer_work_app/ui/common_components/update_work_day_button.dart';
import 'package:volunteer_work_app/ui/pages/common_pages/preview_to_upload_photo_page.dart';
import 'package:volunteer_work_app/ui/pages/organization/programs/org_program_edit_page.dart';
import 'package:volunteer_work_app/ui/pages/organization/work_days/org_view_work_day_details_page.dart';
...
import '../tasks/org_view_task_details_page.dart';

class OrgViewProgramPage extends StatefulWidget {
  const OrgViewProgramPage({Key? key, required this.programDto})
      : super(key: key);

  final VolunteerProgramDto programDto;

  @override
  State<OrgViewProgramPage> createState() => _OrgViewProgramPageState();
}

class _OrgViewProgramPageState extends State<OrgViewProgramPage> {
  int _tabIndex = 0;
  ...
  Widget build(BuildContext context) {
    return BlocListener<UpdateProgramCubit, UpdateProgramState>(
      listener: (context, state) {
        if (state is UpdateProgramSuccess) {
          setState(() {
            _programDto = state.data;
          });

          context
              .read<GetOrganizationProgramsCubit>()
      ...
      child: DefaultTabController(
        ...
        child: Scaffold(
                ...
                IconButton(
                  onPressed: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (_) =>
                                OrgProgramEditPage(programDto: _programDto)));
                  },
                    ...
                    switch (_tabIndex) {
                      case 1:
                        context
                            ...
                            .getTasksOfProgram(programId: _programDto.id!);
                        break;
                      case 2:
                        context
                            .read<GetWorkDaysOfProgramCubit>()
                            .getWorkDaysOfProgram(_programDto.id!);
                        break;
                      case 3:
                        context
                            .read<GetVolunteersOfProgramCubit>()
          ...
          floatingActionButton: _tabIndex == 1
              ? AddNewTaskFloatingButton(
                  programDto: _programDto,
                )
              : _tabIndex == 2
                  ? AddNewWorkDayFloatingButton(
                      programDto: _programDto,
                    )
                  : _tabIndex == 4
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              IconButton(
                                  onPressed: () {
                                    changeVolunteerOrgAssessment(context, item);
                                  },
                                  icon: const Icon(
                                    Icons.edit,
                                    color: Colors.blue,
                                  )),
                              if (item.orgAssessmentGrade != null) ...[
                                Flexible(
                                  child: Column(
                                    mainAxisSize: MainAxisSize.min,
                                    crossAxisAlignment:
