...
class OrgProgramEditPage extends StatefulWidget {
  const OrgProgramEditPage({Key? key, required this.programDto})
      : super(key: key);

  final VolunteerProgramDto programDto;

  @override
  State<OrgProgramEditPage> createState() => _OrgProgramEditPageState();
}

class _OrgProgramEditPageState extends State<OrgProgramEditPage> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<UpdateProgramCubit, UpdateProgramState>(
      listener: (context, state) {
        if (state is UpdateProgramError) {
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('تعديل برنامج التطوع'),
        ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      if (_formKey.currentState?.validate() ?? false) {
                        BlocProvider.of<UpdateProgramCubit>(context)
                            .updateProgram(
                    ...
                    child: Container(
                      ...
                      child: const Center(child: Text('تعديل برنامج التطوع')),
                    ),
                  ),
                ),
                BlocBuilder<UpdateProgramCubit, UpdateProgramState>(
                  builder: (context, state) {
                    if (state is UpdateProgramLoading) {
